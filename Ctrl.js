...
var bars = setInterval(function () {
    ...
    if (barLastTop < 550 || counter == 0) {//if(barLastTop) to make the bars & gaps fit inside the game whiteout scrollbars
        ...
        gap.style.top = gapLastTop + 70 + "px";
    ...
    if (drop == 0) { //So the ball don't drop bellow the bottom of the game
        if (characterTop < 480) {
